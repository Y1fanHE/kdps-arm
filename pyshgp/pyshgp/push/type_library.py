...
from pyshgp.push.atoms import Atom, Literal, VirusLiteral
...
def infer_virus_literal(val: Any, type_library: PushTypeLibrary) -> Literal:
    """Make a virus literal by inferring the PushType of the value.
    ...
    """
    return VirusLiteral(value=val, push_type=type_library.push_type_of(val, error_on_not_found=True))
