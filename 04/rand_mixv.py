...
LastEditTime: 2021-12-17 15:12:27
'''
...
in_sol = [
    Genome([VirusInput(input_index=0),
            VirusInstructionMeta(name="str_length", code_blocks=0)]),
    Genome([VirusInput(input_index=1),
            VirusInstructionMeta(name="str_length", code_blocks=0)]),
    Genome([VirusInput(input_index=2),
            VirusInstructionMeta(name="str_length", code_blocks=0)]),
    Genome([VirusInstructionMeta(name="int_lt", code_blocks=0)]),
    Genome([VirusInstructionMeta(name="bool_and", code_blocks=0)]),
]
