...
LastEditTime: 2021-12-10 02:17:08
'''
...
from pyshgp.push.atoms import VirusCloser, VirusInput, VirusInstructionMeta
...
in_sol = [
    Genome([VirusInput(input_index=0),
            VirusInstructionMeta(name='vector_int_iterate', code_blocks=1)]),
    Genome([infer_virus_literal(val=2, type_library=PushTypeLibrary()),
            VirusInstructionMeta(name='int_mod', code_blocks=0)]),
    Genome([VirusInstructionMeta(name="exec_if", code_blocks=2)]),
    Genome([infer_virus_literal(val=1, type_library=PushTypeLibrary()),
            VirusInstructionMeta(name='int_eq', code_blocks=0)]),
    Genome([VirusInstructionMeta(name="int_inc", code_blocks=0)])
]
